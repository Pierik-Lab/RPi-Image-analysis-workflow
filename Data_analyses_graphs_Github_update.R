...
for(plant in names(RunL)){
  ...
  pet.ang2     <-  atan2(-(ymer - yjun), xmer - xjun) * 180 / pi
  pet.ang1     <- (pet.ang2 + 360) %% 360
  pet.ang      <-  pet.ang1 - 180
  lam.ang2     <-  atan2(-(yjun - ytip), xjun - xtip) * 180 / pi
  lam.ang1     <-  (lam.ang2 + 360) %% 360
  lam.ang      <-  lam.ang1 - 180
  leaf.ang2    <-  atan2(-(ymer - ytip), xmer - xtip) * 180 / pi
  leaf.ang1     <-  (leaf.ang2 + 360) %% 360
  leaf.ang     <-  leaf.ang1 -180
